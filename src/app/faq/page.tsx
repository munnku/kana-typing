...
const FAQ_ITEMS = [
  {
    q: 'ログインや会員登録は必要ですか？',
    a: '不要です。かなタイピングはログインや会員登録なしで全機能をご利用いただけます。レッスンの進捗・設定・バッジなどのデータはすべてブラウザのlocalStorageに自動保存されます。',
  },
  {
    q: 'スマートフォンでも使えますか？',
  ...
  {
    q: '進捗データが消えてしまいました',
    a: 'かなタイピングの進捗データはブラウザのlocalStorageに保存されています。ブラウザの「閲覧データの削除」でキャッシュ・Cookieをクリアした場合や、ブラウザのプライベートモードをご利用の場合はデータが消える場合があります。現在、クラウドへのバックアップ機能はございません。',
  },
  {
    q: 'ローマ字入力とかな入力の違いは？',
